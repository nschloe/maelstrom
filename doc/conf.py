...
latex_documents = [
    ("index", "maelstrom.tex", u"maelstrom Documentation", u"Nico Schlömer", "manual"),
]
...
man_pages = [("index", "maelstrom", u"maelstrom Documentation", [u"Nico Schlömer"], 1)]
